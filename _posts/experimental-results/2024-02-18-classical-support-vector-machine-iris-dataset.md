...
<script>
  function sortTable(n) {
    ...
    table = document.getElementById("classical-svm-iris-dataset-exp-results");
    switching = true;
...
<table id="classical-svm-iris-dataset-exp-results" border="1" class="tg">
  <thead>
    <tr>
      ...
      <th onclick="sortTable(1)">Kernel</th>
      <th onclick="sortTable(2)">C<sup>&sect;</sup></th>
      <th onclick="sortTable(3)">Degree<sup>&dagger;</sup></th>
      <th onclick="sortTable(4)">Gamma<sup>&Dagger;</sup></th>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>N/A</td>
      <td>0.03728</td>
      <td><span style="color:#C0392B"><b>0.06667</b></span></td>
    </tr>
    <tr>
      <th>1506</th>
      <td>sigmoid</td>
